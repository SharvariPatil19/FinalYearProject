...
#
label_l2 = tk.Label(root, text="___Yoga Pose Detection System___",font=("times", 30, 'bold','italic'),
...
button1 = tk.Button(frame_alpr, text="Camera", command=log, width=15, height=1,font=('times', 15, ' bold '), bg="red", fg="white")
button1.place(x=170, y=20)

button2 = tk.Button(frame_alpr, text="Exit",command=window,width=15, height=1,font=('times', 15, ' bold '), bg="green", fg="white")
